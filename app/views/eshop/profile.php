            ...
            <div class="col-md-4 mb" style="background:#eee;text-align:center;box-shadow:0px 0px 20px #aaa;border:solid thin #ddd;>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <p><?=date(" M Y",strtotime($data['user_data']->date));?></p>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <p id="user_text"class="small mt" style="cursor:pointer;color:#13b8ea;font-weight:500;opacity:0.9;"><i class="fa fa-edit"></i> EDIT</p>
                    </div>
                    <div class="col-md-6">
                        <p id="user_text"class="small mt" style="cursor:pointer;color:crimson;font-weight:500;opacity:0.9;"><i class="fa fa-delete"></i> DELETE</p>
                    </div>
                </div>
            </div>
            </div><!-- /col-md-4 -->
